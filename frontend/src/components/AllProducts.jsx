...
import pic from "./pictures/3 something.webp"
...
function AllProduct(){
    ...
    return (
        ...
        <div className="container-fluid" style={{width:"92%"}}>
            <div className="card shadow bg-transparent rounded" style={{border:"none"}}>
                        ...
                        <div className="modal-body">
                            <div className="d-flex">
                                ...
                                <div className="ml-3">
                                    ...
                                    <h5 className="px-2">Origin State: {item.brand}</h5>
